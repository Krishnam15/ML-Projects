...
movies_dict = pickle.load(open(r"C:\Users\KIIT\Desktop\ML_Projects\Movie_Recommender_System\movies_dict.pkl",'rb'))
movies = pd.DataFrame(movies_dict)
similarity = pickle.load(open(r"C:\Users\KIIT\Desktop\ML_Projects\Movie_Recommender_System\similarity.pkl",'rb'))
